...
var _ = Describe("ValidatingWebhookConfiguration controller", func() {
	var instance admissionregistrationv1beta1.ValidatingWebhookConfiguration
	var expectedKey types.ReconcileKey
	var client ValidatingWebhookConfigurationInterface
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			...
			client = ks.AdmissionregistrationV1beta1().ValidatingWebhookConfigurations()
