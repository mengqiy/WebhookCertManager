...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "ValidatingWebhookConfiguration Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	Eventually(func() interface{} {
		return arguments.ControllerManager.GetController("ValidatingWebhookConfigurationController")
	}).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("ValidatingWebhookConfigurationController")
})
