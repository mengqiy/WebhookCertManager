...
var _ = Describe("MutatingWebhookConfiguration controller", func() {
	var instance admissionregistrationv1beta1.MutatingWebhookConfiguration
	var expectedKey types.ReconcileKey
	var client MutatingWebhookConfigurationInterface
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			...
			client = ks.AdmissionregistrationV1beta1().MutatingWebhookConfigurations()
