...
package mutatingwebhookconfiguration_test
...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "MutatingWebhookConfiguration Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	Eventually(func() interface{} {
		return arguments.ControllerManager.GetController("MutatingWebhookConfigurationController")
	}).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("MutatingWebhookConfigurationController")
})
